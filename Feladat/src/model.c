...
void init_object(Object *object, int x, int z, float material_ambient[4], float material_diffuse[4],
                 float material_specular[4], float material_shine, double vx, double vy, double vz) {
    object->position.x = x;
    object->position.y = 1000;
    object->position.z = z;

    object->material_ambient[0] = material_ambient[0];
    object->material_ambient[1] = material_ambient[1];
    object->material_ambient[2] = material_ambient[2];
    object->material_ambient[3] = material_ambient[3];

    object->material_diffuse[0] = material_diffuse[0];
    object->material_diffuse[1] = material_diffuse[1];
    object->material_diffuse[2] = material_diffuse[2];
    object->material_diffuse[3] = material_diffuse[3];

    object->material_specular[0] = material_specular[0];
    object->material_specular[1] = material_specular[1];
    object->material_specular[2] = material_specular[2];
    object->material_specular[3] = material_specular[3];

    object->material_shine = material_shine;
...
void init_entities(World *world) {
    float default_material_ambient[] = {1, 1, 1, 0.5};

    float soccer_mat_ambient[] = {0.05f,0.05f,0.05f,1.0f};
    float soccer_mat_diffuse[] = {0.5f,0.5f,0.5f,1.0f};
    float soccer_mat_specular[] = {0.7f,0.7f,0.7f,1.0f};
    float soccer_mat_shine = 10.0f;

	double vx = 0.01;
	double vy = 0.01;
	double vz = 0.01;

    load_model("models//soccer.obj", &world->object.model);
    world->object.texture = load_texture("textures//soccer_texture.jpg");
    init_object(&world->object, 0, 0, soccer_mat_ambient, soccer_mat_diffuse, soccer_mat_specular, soccer_mat_shine, vx, vy, vz);

    world->room.ground = load_texture("textures//grass.jpg");
    world->room.back = load_texture("textures//sky.jpg");
    world->room.front = load_texture("textures//sky.jpg");
    world->room.left = load_texture("textures//sky.jpg");
    world->room.right = load_texture("textures//sky.jpg");
    world->room.top = load_texture("textures//sky.jpg");

    world->helpTexture = load_texture("textures//help.jpg");
}
